...
$url=$pro_code=$pro_name=$pro_qty=$pro_price=$pro_detail="";
...
<form name="add_product" action="action_admin_products.php<?php if(!empty($url)) echo($url); ?>" method="POST" enctype ="multipart/form-data">
	...
	<tr>
		...
		<td style="width: 78%;"><input type="text" id="pro_code" name="pro_code" value="<?php echo(!empty($pro_code)) ?>" /></td>
	</tr>
	<tr>
		<td>نام کالا<span style="color: red;">*</span></td>
		<td><input type="text" style="text-align: right;" id="pro_name" name="pro_name" value="<?php echo(!empty($pro_name)) ?>"/></td>
	</tr>
		
	<tr>
		<td>موجودی کالا<span style="color: red;">*</span></td>
		<td><input type="text" style="text-align: left;" id="pro_qty" name="pro_qty" value="<?php echo(!empty($pro_qty)) ?>"/></td>
	</tr>
		
	<tr>
		<td>قیمت کالا<span style="color: red;">*</span></td>
		<td><input type="text" style="text-align: left;" id="pro_price" name="pro_price" value="<?php echo(!empty($pro_price)) ?>"/></td>
	</tr>
	...
	<tr>
		...
		<td><textarea id="pro_datail" name="pro_detail" cols="45" rows="10" wrap="virtual"><?php echo($pro_detail) ?></textarea></td>
